...
def check_keys(model, pretrained_state_dict):
    ...
    used_pretrained_keys = model_keys & ckpt_keys # 取并集
    unused_pretrained_keys = ckpt_keys - model_keys # 取差集
    missing_keys = model_keys - ckpt_keys # 取差集
...
def load_pretrain(model, pretrained_path):
    ...
    pretrained_dict = torch.load(pretrained_path,
        map_location=lambda storage, loc: storage.cuda(device)) # 将所有的tensor加载到GPU中
