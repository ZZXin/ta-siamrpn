...
parser.add_argument('--penalty-k', default='0.1,0.2,0.1', type=parse_range)
parser.add_argument('--lr', default='0.4,0.5,0.1', type=parse_range)
parser.add_argument('--window-influence', default='0.1,0.2,0.1', type=parse_range)
